...
def test_retrieve_waveform_data_without_write_access(app, ACCOUNTS, ASSETS):
  app.login(ACCOUNTS['SUPERUSER'])
...
def test_nonexistant_waveform(app, ACCOUNTS, ASSETS):
  app.login(ACCOUNTS['SUPERUSER'])
  response = app.get('/video/fakefakefakefake/waveform.json')
